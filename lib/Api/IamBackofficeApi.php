...
class IamBackofficeApi
{
     ...
     *
     * @param  \GeminiCommerce\Iambackoffice\Model\IambackofficeAssignUserToGroupRequest $body body (required)
     ...
     * @throws \GeminiCommerce\Iambackoffice\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return object|\GeminiCommerce\Iambackoffice\Model\RpcStatus
     */
     ...
     *
     * @param  \GeminiCommerce\Iambackoffice\Model\IambackofficeAssignUserToGroupRequest $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['iamBackofficeAssignUserToGroup'] to see the possible values for this operation
     *
     * @throws \GeminiCommerce\Iambackoffice\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of object|\GeminiCommerce\Iambackoffice\Model\RpcStatus, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * USER
     *
     * @param  \GeminiCommerce\Iambackoffice\Model\IambackofficeGetUserRequest $body body (required)
     ...
     * @throws \GeminiCommerce\Iambackoffice\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \GeminiCommerce\Iambackoffice\Model\IambackofficeGetUserResponse|\GeminiCommerce\Iambackoffice\Model\RpcStatus
     */
     ...
     * USER
     *
     * @param  \GeminiCommerce\Iambackoffice\Model\IambackofficeGetUserRequest $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['iamBackofficeGetUser'] to see the possible values for this operation
     *
     * @throws \GeminiCommerce\Iambackoffice\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \GeminiCommerce\Iambackoffice\Model\IambackofficeGetUserResponse|\GeminiCommerce\Iambackoffice\Model\RpcStatus, HTTP status code, HTTP response headers (array of strings)
     */
    public function iamBackofficeGetUserWithHttpInfo($body, string $contentType = self::contentTypes['iamBackofficeGetUser'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\GeminiCommerce\Iambackoffice\Model\IambackofficeGetUserResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\GeminiCommerce\Iambackoffice\Model\IambackofficeGetUserResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\GeminiCommerce\Iambackoffice\Model\IambackofficeGetUserResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\GeminiCommerce\Iambackoffice\Model\IambackofficeGetUserResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\GeminiCommerce\Iambackoffice\Model\IambackofficeGetUserResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \GeminiCommerce\Iambackoffice\Model\IambackofficeSearchGroupsRequest $body body (required)
     ...
     * @throws \GeminiCommerce\Iambackoffice\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \GeminiCommerce\Iambackoffice\Model\IambackofficeSearchGroupsResponse|\GeminiCommerce\Iambackoffice\Model\RpcStatus
     */
     ...
     *
     * @param  \GeminiCommerce\Iambackoffice\Model\IambackofficeSearchGroupsRequest $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['iamBackofficeSearchGroups'] to see the possible values for this operation
     *
     * @throws \GeminiCommerce\Iambackoffice\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \GeminiCommerce\Iambackoffice\Model\IambackofficeSearchGroupsResponse|\GeminiCommerce\Iambackoffice\Model\RpcStatus, HTTP status code, HTTP response headers (array of strings)
     */
    public function iamBackofficeSearchGroupsWithHttpInfo($body, string $contentType = self::contentTypes['iamBackofficeSearchGroups'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\GeminiCommerce\Iambackoffice\Model\IambackofficeSearchGroupsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\GeminiCommerce\Iambackoffice\Model\IambackofficeSearchGroupsResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\GeminiCommerce\Iambackoffice\Model\IambackofficeSearchGroupsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\GeminiCommerce\Iambackoffice\Model\IambackofficeSearchGroupsResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\GeminiCommerce\Iambackoffice\Model\IambackofficeSearchGroupsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
