...
class IambackofficeTwoFactorMethod implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'authenticator' => '\OpenAPI\Client\Model\IambackofficeAuthenticatorConfiguration',
        'email' => 'string',
        'id' => 'string',
        'method' => 'string',
        'mobile_phone' => 'string',
    ...
    */
     ...
     * Gets authenticator
     *
     * @return \OpenAPI\Client\Model\IambackofficeAuthenticatorConfiguration|null
     */
     ...
     * Sets authenticator
     *
     * @param \OpenAPI\Client\Model\IambackofficeAuthenticatorConfiguration|null $authenticator authenticator
     *
     * @return self
     */
